...
namespace PiRhoSoft.DocGen.Editor
{
	...
	public class DocumentationSection
	{
		...
		[EnumButtons(true)] public DeclarationType IncludedDeclarations = DeclarationType.Instance;
		[EnumButtons(true)] public AccessLevel IncludedAccessLevels = AccessLevel.Public | AccessLevel.Protected;
		[EnumButtons(true)] public MemberType IncludedMemberTypes = MemberType.Field;
		...
		private static readonly List<string> _ignoredMethods = new List<string>
		{
			"OnAfterDeserialize",
			"OnBeforeSerialize"
		};
